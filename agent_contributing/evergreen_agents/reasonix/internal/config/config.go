...
// flag > project ./reasonix_gr.toml > user config.toml (in the OS user-config dir) > built-in defaults.
...
// the project roots (.reasonix_gr/.agents/.agent/.claude under the workspace) and
...
type AgentConfig struct {
	...
	// .reasonix_gr/output-styles/<name>.md). Empty = the unmodified prompt.
...
// reasonix_gr.toml's [[plugins]] or a project-root .mcp.json (see loadMCPJSON).
