...
type Messages struct {
	...
	WroteFileFmt          string // "Wrote %s" — used for reasonix_gr.toml and .env both
	...
	SkipStaleCustomEntryFmt    string // "skipping stale %q entry from reasonix_gr.toml (pointing at %s) — please remove it"
