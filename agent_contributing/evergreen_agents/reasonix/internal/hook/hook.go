...
// (.reasonix_gr/settings.json, only when the project is trusted) and a global
// (~/.reasonix_gr/settings.json) file. A hook's exit
...
// ProjectSettingsPath is <root>/.reasonix_gr/settings.json.
