...
func TestClassifyRef(t *testing.T) {
	...
	files := map[string]bool{
		"src/main.go": true,
		"README.md":   true,
		".reasonix_gr/attachments/clipboard-20260601-010203.000000.png": true,
		".reasonix_gr/attachments/clipboard-20260601-010203.000000.yml": true,
		".reasonix_gr/attachments/clipboard-20260601-010203.000000.zip": true,
	}
	...
	cases := []struct {
		...
		{".reasonix_gr/attachments/clipboard-20260601-010203.000000.png", true, refImage},
		{".reasonix_gr/attachments/clipboard-20260601-010203.000000.yml", true, refFile},
		{".reasonix_gr/attachments/clipboard-20260601-010203.000000.zip", true, refFile},
...
func TestResolveRefsAttachmentKinds(t *testing.T) {
	temp := t.TempDir()
	attachmentsDir := filepath.Join(temp, ".reasonix_gr", "attachments")
	if err := os.MkdirAll(attachmentsDir, 0o755); err != nil {
		t.Fatal(err)
	}
	ymlRef := filepath.ToSlash(".reasonix_gr/attachments/config.yml")
	zipRef := filepath.ToSlash(".reasonix_gr/attachments/archive.zip")
	pngRef := filepath.ToSlash(".reasonix_gr/attachments/shot.png")
...
func TestWorkspaceImageRefsAlsoAttachAsModelImages(t *testing.T) {
	...
	attachment := filepath.Join(workspace, ".reasonix_gr", "attachments", "shot.png")
	...
	if refs[1].kind != refImage || refs[1].path != ".reasonix_gr/attachments/shot.png" {
