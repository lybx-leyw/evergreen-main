...
/// `cp_evergreen_push/lib/features/courses/widgets/timetable_grid.dart`
/// 原样拷入（仅 import 路径改 evg-base，无其他改动——参考实现长期验证）。
library;
...
class TimetableGrid extends StatelessWidget {
  final List<ZjuTimetableSession> sessions;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final grid = List.generate(
            13, (_) => List.generate(7, (_) => <ZjuTimetableSession>[]));
