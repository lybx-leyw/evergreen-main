...
import 'package:evergreen_base/core/agent/tools/agent_process_registry.dart';
...
final agentRuntimeProvider = Provider<AgentRuntime>((ref) {
  ...
  // 与 app_bootstrap 主路径）。PROJECT_ROOT 兜底当前目录（Chaquopy CWD=/，
  // 真实路径以 GREENIX_CONFIG_PATH 为准）。
