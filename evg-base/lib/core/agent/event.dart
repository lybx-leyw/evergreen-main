/// Agent 类型化事件流 — 对应 reasonix/internal/event/event.go。
library;
...
/// Token 用量。对应 Go 的 provider.Usage。
class TokenUsage {
...
/// 子 Agent 模型/努力级别。对应 Go 的 event.Profile。
class AgentProfile {
  final String model;
  final String effort;
...
/// StreamController 桥接 EventSink → Stream。
