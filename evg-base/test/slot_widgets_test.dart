...
import 'package:evergreen_base/renderer/components/document/audio_player_slot.dart';
import 'package:evergreen_base/renderer/components/learning/crossword_slot.dart';
import 'package:evergreen_base/renderer/components/controls/custom_slot.dart';
import 'package:evergreen_base/renderer/components/document/diff_viewer_slot.dart';
import 'package:evergreen_base/renderer/components/document/image_gallery_slot.dart';
import 'package:evergreen_base/renderer/components/document/notepad_slot.dart';
import 'package:evergreen_base/renderer/components/interaction/prompt_builder_slot.dart';
import 'package:evergreen_base/renderer/components/learning/pronunciation_slot.dart';
import 'package:evergreen_base/renderer/components/creative/terminal_slot.dart';
import 'package:evergreen_base/renderer/components/data/tree_slot.dart';
import 'package:evergreen_base/renderer/components/controls/webview_slot.dart';
import 'package:evergreen_base/renderer/components/creative/whiteboard_slot.dart';
  ...
  testWidgets('M1 全部 Dart 槽位：可渲染且真实字段出现', (tester) async {
    ...
    await _pump(
      ...
      CustomSlot(
        config: ComponentDescriptor(
          type: 'custom',
          config: {'html': 'M1D_CUSTOM_SRC'},
        ),
      ),
    );
    expect(tester.takeException(), isNull);
    expect(find.text('M1D_CUSTOM_SRC'), findsWidgets);
