...
class _VideoPlayerPanelState extends State<VideoPlayerPanel> {
  ...
  Future<void> _initPlayer() async {
    ...
    try {
      ...
      // Keep UI in sync with external rate changes
      ...
      if (widget.videoUrl.isNotEmpty) {
        ...
        if (savedRate != null && savedRate > 0) {
          ...
          debugPrint('[VideoPlayer] restored rate: ${savedRate}x');
        }
      }
  ...
  Future<void> _setPlaybackRate(double rate) async {
    ...
    debugPrint('[VideoPlayer] rate set: ${rate}x');
  }
  ...
  Widget _buildControlBar(BuildContext context) {
    ...
    // Show a compact row of commonly used speeds; the "more" button shows all
    const quickSpeeds = [0.5, 0.75, 1.0, 1.25, 1.5, 2.0];
    const maxVisibleSpeeds = 6;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Quick speed chips (most-used)
          ...quickSpeeds.take(maxVisibleSpeeds).map((speed) {
                  ...
                  children: [
                    ...
                    if (speed == 1.0)
                      Padding(
                        ...
                        child: Text('(正常)', style: TextStyle(color: Colors.grey[500], fontSize: 11)),
                      ),
                  ],
                ),
              );
          ...
          Container(
            ...
            child: Text(
              '${_playbackRate}x',
              style: TextStyle(
                color: _playbackRate != 1.0 ? theme.colorScheme.primary : Colors.white70,
                fontSize: 12,
