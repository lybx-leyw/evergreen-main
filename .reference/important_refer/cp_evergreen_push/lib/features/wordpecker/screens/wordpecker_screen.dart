...
class _PracticeArea extends ConsumerWidget {
  final String word;
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _ratingButton(context, ref, 'Again', FsrsCard.ratingAgain, Colors.red),
              const SizedBox(width: 12),
              _ratingButton(context, ref, 'Hard', FsrsCard.ratingHard, Colors.orange),
              const SizedBox(width: 12),
              _ratingButton(context, ref, 'Good', FsrsCard.ratingGood, Colors.green),
              const SizedBox(width: 12),
              _ratingButton(context, ref, 'Easy', FsrsCard.ratingEasy, Colors.blue),
            ],
          ),
        ],
      ),
  ...
  Widget _ratingButton(BuildContext context, WidgetRef ref, String label, int rating, Color color) {
