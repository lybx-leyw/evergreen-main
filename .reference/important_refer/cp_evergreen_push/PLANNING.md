# PLANNING — Evergreen Multi-Tools v1.4.0
...
- **当前版本**: v1.4.0 内测版（功能模块 18 个：rvpn 已启用 + Palace 认知中间件）
- **目标版本**: v2.0.0（完整重构 + 多 Agent 联邦稳定）
- **时间窗口**: 2026 年暑假
- **用户范围**: 内测用户，暂不公开推广
...
| RVPN 进一步优化 | 需 zju-connect 生命周期自动化 + 自动重连 |
...
*创建于 2026-06-16 · 更新于 2026-06-25（rvpn 启用，版本升至 v1.4.0）*
