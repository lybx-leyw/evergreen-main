...
class AutosignScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bgEnabled = ref.watch(autosignBackgroundEnabledProvider);
              ...
              child: Column(
                ...
                children: [
                      ...
                      FilledButton.icon(
                        onPressed: () {
                          if (isRunning) {
                            ...
                            final error = ref.read(autosignLogProvider.notifier).start();
                            if (error != null) {
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text('自动刷新触发时同步检测签到'),
                    value: bgEnabled,
                    onChanged: (v) {
                      ref.read(autosignBackgroundEnabledProvider.notifier).state = v;
                    },
