"""Extract HTML render functions — v3: skip signature, body starts from {."""
import re, os
...
# Extract each function body (from opening { to closing })
extracted = {}
for start_line, name in func_starts:
    ...
    # Start body from the opening brace line (includes it)
    body_lines = []
    depth = 0
